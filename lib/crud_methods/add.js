...
*   (documentPassed<Object> && ?callbackPassed<function>)
*
...
function _insertDocument(documentToInsert, collection, configuration, callbackPassed, constructorInstance) {
    ...
    return collection
                .insertOne(documentToInsert, insertDocument_cb);


    //  Insert document callback
    function insertDocument_cb(errorInsertingDocument, documentInserted) {

        //  Document not inserted
        if (errorInsertingDocument) {
