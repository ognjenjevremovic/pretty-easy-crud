...
var setParams   =   require('./core'),
    crudMethods =   require('./crud_methods');
...
*/
DatabaseCRUD.prototype.add =    DatabaseCRUD.prototype.insert = function(documentToAdd, callbackFunction) {
    return crudMethods.add.call(this, documentToAdd, callbackFunction);
};
/*
