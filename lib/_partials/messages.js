/*
*   Get messages function (module)
*   Function accepts an optional parameter that
*   represents the more information and will be
*   added to the message.
*
*   Returns an Object with messages
*
*/
function messagesFn(moreInfo) {
    ...
    //  Define the return Object value
...
*       -   returns Object (representing the messages)
*
*/
