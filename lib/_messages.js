...
function messages(moreInfo) {
    ...
    collectionMessages.validCollection      =   ['Connection established', splitter, 'Successfuly connected to the ' + moreInfo.dbName + ' database - ' + moreInfo.collectionName + ' collection.'];
